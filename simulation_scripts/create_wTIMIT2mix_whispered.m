% create_wTIMIT2mix_whispered.m
%
% Script to create the whispered part of the wTIMIT2mix speech database. It 
...
%output_dir16k='PATH2/wTIMIT/wTIMIT2mix/whispered/wav16k';
output_dir8k='PATH2/wTIMIT/wTIMIT2mix/whispered/wav8k';
...
for i_mm = 1:length(min_max)
    for i_type = 1:length(data_type)
        ...
        TaskFile = [task_list '/' data_type{i_type} '_spk_mix_w.txt'];
